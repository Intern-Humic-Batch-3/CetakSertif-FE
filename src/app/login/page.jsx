		...
		<div className="flex flex-col md:flex-row h-screen">
			...
			<div className="md:hidden bg-brand-primary text-white flex flex-col items-center justify-center py-14 px-10">
				...
				<Image
					...
					className="my-8"
				/>
				<h6 className="text-lg font-semibold text-center mb-3">Selamat Datang!</h6>
			...
			<div className="bg-white w-full md:w-[56vw] flex items-center justify-center text-black px-8 md:px-12 mt-10 md:mt-0">
				<div className="w-full max-w-[400px] md:max-w-[500px]">
					...
					<form className="flex flex-col mt-5 xl:mt-0 gap-y-5">
						<div>
							<Label
								htmlFor="email"
								value="Email"
							...
							<input
								...
								required
								className="w-full rounded-lg border border-neutral-300 focus:ring-error focus:border-error text-base py-4 px-4"
							/>
						</div>
						<div>
							<Label
								...
								className="mb-2 block font-semibold text-lg"
							/>
							<div className="flex items-center border border-neutral-300 focus:ring-error focus:border-error rounded-lg pr-4">
								<input
									className="w-full bg-transparent border-0 focus:ring-0 text-base py-4"
									id="password"
